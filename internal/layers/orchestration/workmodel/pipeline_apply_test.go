...
func TestStatusAfterSpawnNone_should_stay_in_progress_when_partial_without_deliverable(t *testing.T) {
	got := StatusAfterSpawnNone(types.VerdictPartial, FirstRegisteredDeliverableSchema(), DeliverableStatusIncomplete)
...
func TestStatusAfterSpawnNone_should_complete_when_partial_with_complete_deliverable(t *testing.T) {
	got := StatusAfterSpawnNone(types.VerdictPartial, FirstRegisteredDeliverableSchema(), DeliverableStatusComplete)
...
func TestStatusAfterSpawnNone_should_fail_when_verdict_fail_and_incomplete(t *testing.T) {
	got := StatusAfterSpawnNone(types.VerdictFail, FirstRegisteredDeliverableSchema(), DeliverableStatusIncomplete)
