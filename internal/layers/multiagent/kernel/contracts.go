// Package kernel holds the multi-agent domain kernel types and interfaces.
//
// Migrated from multiagent/contracts.go + multiagent/observer/ (v2.0-d).
// This is the canonical home for Agent, AgentConfig, AgentState, AgentObserver,
// and related core contracts. The root multiagent package re-exports these
