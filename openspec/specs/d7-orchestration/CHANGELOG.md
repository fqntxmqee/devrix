...
|------|-----------|------|------|------|
| 2026-07-04 | d7-uncertainty-spawn-decouple | CC-U1～U6：Spawn 主信号回归 U+证据进度；deliverable gate 降级呈现层；RollupSynth on format failure；strategic single U gate；alias registry salvage | IMPLEMENTED | [changes](../../changes/d7-uncertainty-spawn-decouple/) |
