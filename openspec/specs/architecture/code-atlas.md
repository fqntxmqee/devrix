...
| toolrunner | 工具执行与沙箱 | D2-S3-A03/A04 | `contextengine/enforce/toolrunner/` | `ToolRunner`, `Sandbox`, builtins |
...
| permission_mode | Plan 写过滤 | D2-S3-A01 | `contextengine/enforce/permission/` | `Mode`, `PlanFilePath` |
...
| `IToolRunner`, `IToolRegistry` | `contextengine/enforce/toolrunner/` | D2 QueryLoop, registry |
| `ToolRegistry`, builtins | `contextengine/enforce/toolrunner/` | bash, read_file, glob, grep, edit |
