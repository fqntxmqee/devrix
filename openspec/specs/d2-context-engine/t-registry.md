...
**Change:** mups-semantics-schema-alignment (DM-20260705-003) S7_Archived 2026-07-05: prompttags 语义层 prose → machine-readable JSON-lines (`SemanticRule` + `SemanticBlock` + `InputRulesForFrame`); 与 DM-001 (`mups-prompt-tag-semantics`) 共享 §D2-S15-A97 capability, 不新增 t-registry 段, 实质是 A97 序列 schema 演进 (prose → JSON) S5 增量延伸归档; 4 L5 L5-MUPS-TAG-01..04 PASS; 8 T 共享 A97: shared-A97-T01..T04 + D2-S15-A97-T01..T04; `openspec/archive/2026-07-05-mups-semantics-schema-alignment/`.
