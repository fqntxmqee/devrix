...
|------|-----------|------|------|------|
| 2026-07-02 | devrix-mups-tool-classification-and-channel-autonomy | ToolSpec v3 (6 control plane 字段 + 19 工具默认 metadata + silent default CI gate) + Filter v2 三维 (per_emission_class + per_task_kind + per_agent) + TruncateWithMarker; 19 T IMPLEMENTED (D2-S15-A02-T02..T15, 含 1 T01 复用) | IMPLEMENTED | [archive](../../archive/2026-07-02-devrix-mups-tool-classification-and-channel-autonomy/) |
