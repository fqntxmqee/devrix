...
**Status:** S7_Archiving（v1.0/v2.0-d 全部验收通过；8 commits；S7 物理归档执行中）
...
| E-e3 | E2E agent_fork + delegate 回归 | E-e1 | D4-S0-T04 | P0 | ✅ 3 预存错误已修复 (60939db) + 1 迁移 bug (4e48f83) |
| E-e4 | 删除旧路径 dead code + re-export | E-e1 | cleanup PR | — | ✅ 5 re-export shim (e30fe72) + delegate/ (720a4b1) |
| E-e5 | 更新 `layering.md` Domain Layout + code-layout §4.4 状态 | E-d7 | specs | — | ✅ |
| E-e6 | 写 `acceptance-report（v2.0）` | E-e1–E-e5 | ACCEPTED | — | ✅ |
| E-e7 | S7 归档 + `demand-archive-index.md` | E-e6 | archive | — | 🔄 进行中 |
