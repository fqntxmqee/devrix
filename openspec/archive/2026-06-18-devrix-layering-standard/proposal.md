...
**Status:** S7_Archived (2026-06-18; S0_Deferred at creation; partial delivery via out-of-band channels)
**Author:** Devrix Team
**Date:** 2026-06-08 → Archived 2026-06-18

> **归档说明 (2026-06-18)：** 本 demand 初始 S0_Deferred；D-S-A-F-T 完整方案与现网 L1-L2 格式冲突未解决。但分层 ID 规范的基础设施通过其他渠道落地：`openspec/specs/architecture/code-layout.md`（目录 ID 规范）、`openspec/specs/architecture/layering.md`（D1-D7 分层）、`openspec/specs/architecture/code-atlas.md`（代码索引）、`openspec/t-registry.md` + `openspec/specs/d{N}-*/t-registry.md`（T 点注册表）。**作为 S7_Archived 归档；D-S-A-F-T 完整方案不再实施。**
