...
- [ ] T-2.1 切出 `feat/devrix-d6-spec-lite` 分支
- [ ] T-2.2 重写 `spec.md` 604 → ≤ 200（18 条 Requirements → 1 行 reference + archive/）
- [ ] T-2.3 新建 `CHANGELOG.md` ≤ 300
- [ ] T-2.4 验证（wc -l / go vet / 0 Go diff / 0 d6 子文档 diff）
