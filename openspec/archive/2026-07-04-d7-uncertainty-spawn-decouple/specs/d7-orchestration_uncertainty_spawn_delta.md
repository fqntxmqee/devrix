# Delta: D7 Orchestration — Uncertainty-Driven Spawn (Deliverable Decouple)
...
**Depends on:** [`d7-convergence-contract`](../d7-convergence-contract/specs/d7-orchestration_convergence_delta.md) CC-1～CC-5
...
| Document | Section |
|----------|---------|
| `pipeline-architecture.md` | §4.1 Convergence Contract → add CC-U1～U6 |
| `d7-convergence-contract/design.md` | §CC-1.2 inline budget preserved; CC-U1 changes when inline applies |
| `t-registry.md` | Register L5-D7-U-01～U-05 |
