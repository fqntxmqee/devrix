...
- [ ] T-2.1 切出 `feat/devrix-d4-spec-lite` 分支
- [ ] T-2.2 重写 `spec.md` 222 → ≤ 200（Sub-Agent Mode Field 54 行 → 1 行 reference + archive/）
- [ ] T-2.3 新建 `CHANGELOG.md` ≤ 300
- [ ] T-2.4 验证（wc -l / go vet / 0 Go diff / 0 d4 子文档 diff）
...
- devrix-d4-design-split（design.md 1064 行）
