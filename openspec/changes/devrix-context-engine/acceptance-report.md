...
| L5-LLM-01 | Anthropic 适配器流式响应 | P0 | SKIP | status=PLANNED |
| L5-LLM-02 | DeepSeek 适配器流式响应 | P0 | SKIP | status=PLANNED |
| L5-LLM-03 | OpenAI 兼容适配器响应 | P0 | SKIP | status=PLANNED |
| L5-LLM-04 | Circuit breaker 正常关闭 | P0 | SKIP | status=PLANNED |
| L5-LLM-05 | Circuit breaker 触发开启 | P0 | SKIP | status=PLANNED |
| L5-LLM-06 | Circuit breaker 半开→关闭 | P0 | SKIP | status=PLANNED |
| L5-LLM-07 | Circuit breaker 半开→开启 | P0 | SKIP | status=PLANNED |
| L5-LLM-08 | Token 计数准确性 (cl100k_base) | P0 | SKIP | status=PLANNED |
| L5-LLM-09 | Token 预算检查 | P0 | SKIP | status=PLANNED |
| L5-LLM-10 | Provider 配置加载 | P0 | SKIP | status=PLANNED |
