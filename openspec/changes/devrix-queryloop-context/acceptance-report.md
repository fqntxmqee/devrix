...
- Spec delta 已合并：`openspec/specs/context-engine/spec.md` (V6)、`orchestration/spec.md`、`multi-agent/spec.md` (D4-S10)
- 架构注册：`openspec/specs/architecture/layering.md` v2.1、`code-atlas.md`  
