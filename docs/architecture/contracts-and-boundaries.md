...
| `IToolRunner` | **`contextengine/enforce/toolrunner/contracts.go`** | D2 QueryLoop |
| `IToolRegistry` | **`contextengine/enforce/toolrunner/contracts.go`** | D2 registry/bootstrap |
